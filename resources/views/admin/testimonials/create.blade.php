...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-plus-circle text-orange me-2"></i>Add Testimonial
    </h4>
            ...
            <x-form-section title="Reviewer Info" icon="fas fa-user-circle">
                <div class="row gy-4">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="text" name="role_or_company" class="form-control @error('role_or_company') is-invalid @enderror" value="{{ old('role_or_company') }}" placeholder="e.g. Student / CEO at TechCorp">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-12">
                        ...
                        <div id="star-rating-container" class="d-flex align-items-center mb-2" style="cursor: pointer;">
                            @for($i=1; $i<=5; $i++)
                                <i class="fas fa-star fa-2x star-icon {{ old('rating', 5) >= $i ? 'text-warning' : 'text-light' }}" data-value="{{ $i }}"></i>
                            @endfor
                            <span id="rating-text" class="ms-3 fw-bold text-dark fs-5">{{ old('rating', 5) }}/5</span>
                        </div>
