...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-edit text-orange me-2"></i>Edit Static Page: {{ $page->title }}
    </h4>
            ...
            <x-form-section title="Page Content" icon="fas fa-pen-nib">
                <div class="row gy-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="content" id="page-content" class="form-control @error('content') is-invalid @enderror" rows="20">{{ old('content', $page->content) }}</textarea>
            ...
            <x-form-section title="SEO Settings" icon="fas fa-search">
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        <input type="text" name="seo_title" id="seo_title" class="form-control mt-2 @error('seo_title') is-invalid @enderror" value="{{ old('seo_title', $page->seo_title) }}" placeholder="Leave blank to use page title" maxlength="60">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="seo_description" id="seo_description" class="form-control mt-2 @error('seo_description') is-invalid @enderror" rows="3" maxlength="160">{{ old('seo_description', $page->seo_description) }}</textarea>
