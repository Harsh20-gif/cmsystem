...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">Add Branch</h4>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 d-flex align-items-center">
                <div class="form-check mt-4">
                    <input class="form-check-input" type="checkbox" name="is_head_office" value="1" id="is_head_office" {{ old('is_head_office') ? 'checked' : '' }}>
            ...
            <div class="col-12">
                ...
                <textarea name="map_embed_code" class="form-control @error('map_embed_code') is-invalid @enderror" rows="3">{{ old('map_embed_code') }}</textarea>
            ...
            <div class="col-12 mt-4">
                <button type="submit" class="btn btn-orange">Save Branch</button>
            </div>
        </div>
    </form>
</div>
