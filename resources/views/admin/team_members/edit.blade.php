...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">Edit Team Member</h4>
    ...
    <form action="{{ route('admin.team-members.update', $teamMember) }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                ...
                <textarea name="bio" class="form-control @error('bio') is-invalid @enderror" rows="3">{{ old('bio', $teamMember->bio) }}</textarea>
                @error('bio')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            <div class="col-md-6">
                <x-media-picker name="photo" id="photo" label="Profile Photo" :value="old('photo', $teamMember->photo)" />
            </div>

            <div class="col-12 mt-4">
                <button type="submit" class="btn btn-orange">Update Team Member</button>
            </div>
        </div>
    </form>
</div>
