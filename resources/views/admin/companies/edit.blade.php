...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-edit text-orange me-2"></i>Edit Company: {{ $company->name }}
    </h4>
...
<form action="{{ route('admin.companies.update', $company) }}" method="POST" id="companyForm" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <x-form-section title="Company Info" icon="fas fa-building">
                <div class="row gy-4">
                    ...
                    <div class="col-12">
                        ...
                        <input type="url" name="website" class="form-control @error('website') is-invalid @enderror" value="{{ old('website', $company->website) }}" placeholder="https://example.com">
            ...
            <x-form-section title="Company Logo" icon="fas fa-image">
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        @if($company->logo)
                            <div class="mb-2">
                                <img src="{{ asset('frontend/assets/' . $company->logo) }}" alt="Company Logo" class="img-thumbnail" style="max-height: 150px;">
                            </div>
                        @endif
            ...
            <div class="card shadow-sm border-0 mb-4 bg-white rounded-3 position-sticky" style="top: 20px;">
                <div class="card-body p-4 text-center">
                    <button type="submit" class="btn btn-orange w-100 mb-3 py-2 fw-semibold btn-hover-lift" id="submitBtn">
                        <span class="normal-state"><i class="fas fa-save me-1"></i> Update Company</span>
