...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">Edit Testimonial</h4>
    ...
    <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="role_or_company" class="form-control @error('role_or_company') is-invalid @enderror" value="{{ old('role_or_company', $testimonial->role_or_company) }}">
            ...
            <div class="col-md-6">
                ...
                <input type="url" name="video_url" class="form-control @error('video_url') is-invalid @enderror" value="{{ old('video_url', $testimonial->video_url) }}">
            ...
            <div class="col-md-4">
                <x-media-picker name="photo" id="photo" label="Reviewer Photo" :value="old('photo', $testimonial->photo)" />
            </div>
            ...
            <div class="col-12 mt-4">
                <button type="submit" class="btn btn-orange">Update Testimonial</button>
            </div>
        </div>
    </form>
</div>
