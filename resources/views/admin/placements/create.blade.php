...
<form action="{{ route('admin.placements.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="admin-card p-4 h-100">
                ...
                <div class="form-group mb-0">
                    ...
                    <div class="position-relative mt-2" style="border: 2px dashed #cbd5e1; border-radius: 8px; padding: 2rem; text-align: center; cursor: pointer; transition: all 0.3s ease; background-color: #f8fafc;" onclick="document.getElementById('imageUpload').click()" id="dropzone">
                        
                        <div id="imagePreviewContainer" class="d-none">
                            <img id="imagePreview" src="" alt="Preview" style="max-width: 100%; max-height: 200px; border-radius: 4px; object-fit: contain;">
        ...
        <div class="col-12 mt-3 mb-5 d-flex gap-3 align-items-center">
            <button type="submit" class="btn btn-orange px-4 py-2 fw-bold"><i class="fas fa-save me-1"></i> Save Placement</button>
