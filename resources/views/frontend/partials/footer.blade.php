        ...
        <div class="container">
            ...
            <div class="row gy-5 gx-lg-5 mb-5">
                ...
                <div class="col-12 col-lg-3 col-md-6">
                    <h4 class="footer-title mb-4 pb-2" style="border-bottom: 2px solid rgba(255,255,255,0.1); display: inline-block;">{{ $siteSettings['footer_quick_links_title'] ?? 'Quick Links' }}</h4>
                    <ul class="footer-links list-unstyled d-flex flex-column gap-3 mb-0">
                        ...
                        @empty
                            <li><a href="{{ route('courses') }}" class="text-decoration-none"><i class="fas fa-angle-right me-2 text-accent-cyan"></i> {{ $siteSettings['nav_courses'] ?? 'Courses' }}</a></li>
                            <li><a href="{{ route('corporate-training') }}" class="text-decoration-none"><i class="fas fa-angle-right me-2 text-accent-cyan"></i> {{ $siteSettings['nav_trainings'] ?? 'Trainings' }}</a></li>
                            <li><a href="{{ route('placements') }}" class="text-decoration-none"><i class="fas fa-angle-right me-2 text-accent-cyan"></i> {{ $siteSettings['nav_placements'] ?? 'Placements' }}</a></li>
                            <li><a href="{{ route('gallery') }}" class="text-decoration-none"><i class="fas fa-angle-right me-2 text-accent-cyan"></i> {{ $siteSettings['nav_gallery'] ?? 'Gallery' }}</a></li>
                            <li><a href="{{ route('about') }}" class="text-decoration-none"><i class="fas fa-angle-right me-2 text-accent-cyan"></i> {{ $siteSettings['nav_about'] ?? 'About Us' }}</a></li>
                            <li><a href="{{ route('contact') }}" class="text-decoration-none"><i class="fas fa-angle-right me-2 text-accent-cyan"></i> {{ $siteSettings['nav_contact'] ?? 'Contact Us' }}</a></li>
                        @endforelse
                    </ul>
                </div>
                ...
                <div class="col-12 col-lg-4 col-md-6">
                    <h4 class="footer-title mb-4 pb-2" style="border-bottom: 2px solid rgba(255,255,255,0.1); display: inline-block;">{{ $siteSettings['footer_contact_title'] ?? 'Contact Us' }}</h4>
