...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-user-plus text-orange me-2"></i>Add Team Member
    </h4>
            ...
            <x-form-section title="Social Links" icon="fas fa-link">
                <div class="row gy-4">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="url" name="twitter_url" class="form-control @error('twitter_url') is-invalid @enderror" value="{{ old('twitter_url') }}" placeholder="https://twitter.com/username">
