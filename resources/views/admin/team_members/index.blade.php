                    ...
                    <tr>
                        <td class="ps-4">
                            <div class="d-flex align-items-center">
                                @if($member->photo)
                                    <img src="{{ asset('frontend/assets/' . $member->photo) }}" class="rounded-circle me-3 border border-2 border-orange" style="width: 48px; height: 48px; object-fit: cover; padding: 2px;">
                                @else
