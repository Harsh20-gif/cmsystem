...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-edit text-orange me-2"></i>Edit Notice / Marquee
    </h4>
            ...
            <x-form-section title="Notice Content" icon="fas fa-bullhorn">
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        <input type="text" name="title" id="notice-title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $notice->title) }}" required placeholder="e.g. New Batch Starting Soon!">
                    ...
                    <div class="col-12">
                        ...
                        <input type="url" name="link" class="form-control @error('link') is-invalid @enderror" value="{{ old('link', $notice->link) }}" placeholder="https://example.com/...">
                ...
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        <select name="type" id="display-area-select" class="form-select @error('type') is-invalid @enderror" required>
                            <option value="board" {{ old('type', $notice->type) == 'board' ? 'selected' : '' }}>Notice Board</option>
                            <option value="marquee" {{ old('type', $notice->type) == 'marquee' ? 'selected' : '' }}>Scrolling Marquee</option>
                        </select>
