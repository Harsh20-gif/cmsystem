...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">Add Training</h4>
    ...
    <form action="{{ route('admin.trainings.store') }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="mode" class="form-control @error('mode') is-invalid @enderror" value="{{ old('mode') }}" placeholder="e.g. Offline">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="seats" class="form-control @error('seats') is-invalid @enderror" value="{{ old('seats') }}">
            ...
            <div class="col-12 mt-4">
                <button type="submit" class="btn btn-orange">Save Training</button>
            </div>
        </div>
    </form>
</div>
