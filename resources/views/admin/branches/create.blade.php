...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-plus-circle text-orange me-2"></i>Add Branch
    </h4>
                ...
                <div class="row gy-4 align-items-end">
                    ...
                    <div class="col-md-5 col-12">
                        <div class="form-check form-switch p-3 border rounded-3 transition-all" id="head-office-wrapper">
                            <input class="form-check-input ms-0 mt-1 me-2" type="checkbox" role="switch" name="is_head_office" value="1" id="is_head_office" {{ old('is_head_office') ? 'checked' : '' }} style="transform: scale(1.2);">
            ...
            <x-form-section title="Map" icon="fas fa-map">
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        <textarea name="map_embed_code" id="map_embed_code" class="form-control @error('map_embed_code') is-invalid @enderror" rows="3">{{ old('map_embed_code') }}</textarea>
                        <div class="form-text">
