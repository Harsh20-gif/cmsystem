...
@section('title', 'Edit Engineering Branch')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-edit text-orange me-2"></i>Edit Engineering Branch
    </h4>
...
<form action="{{ route('admin.engineering-branches.update', \$engineeringBranch) }}" method="POST">
    @csrf
    @method('PUT')
            ...
            <x-form-section title="Branch Info" icon="fas fa-info-circle">
                <div class="row gy-4">
                    <div class="col-md-6 col-12">
                        ...
                        <input type="text" name="name" id="branchName" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $engineeringBranch->name) }}" required>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="number" name="order_position" class="form-control @error('order_position') is-invalid @enderror" value="{{ old('order_position', $engineeringBranch->order_position) }}" required>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            <option value="draft" {{ old('status', $engineeringBranch->status) == 'draft' ? 'selected' : '' }}>Draft</option>
                            <option value="published" {{ old('status', $engineeringBranch->status) == 'published' ? 'selected' : '' }}>Published</option>
                        </select>
