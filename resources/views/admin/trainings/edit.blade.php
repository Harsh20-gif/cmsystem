...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">
        <i class="fas fa-edit text-orange me-2"></i>Edit Training
    </h4>
            ...
            <x-form-section title="Basic Info" icon="fas fa-info-circle">
                <div class="row gy-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="6">{{ old('description', $training->description) }}</textarea>
            ...
            <x-form-section title="Schedule & Details" icon="fas fa-calendar-alt">
                <div class="row gy-4">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="text" name="mode" class="form-control @error('mode') is-invalid @enderror" value="{{ old('mode', $training->mode) }}" placeholder="e.g. Offline / Online">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="number" name="seats" class="form-control @error('seats') is-invalid @enderror" value="{{ old('seats', $training->seats) }}" placeholder="e.g. 50">
