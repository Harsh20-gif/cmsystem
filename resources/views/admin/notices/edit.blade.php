...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0 text-navy fw-bold">Edit Notice / Marquee</h4>
    ...
    <form action="{{ route('admin.notices.update', $notice) }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="link" class="form-control @error('link') is-invalid @enderror" value="{{ old('link', $notice->link) }}" placeholder="https://...">
            ...
            <div class="col-12 mt-4">
                <button type="submit" class="btn btn-orange">Update Notice</button>
            </div>
        </div>
    </form>
</div>
